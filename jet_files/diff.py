...
def diff():
    # A simple method that gives the difference between the current version of the filename
    # And the version specificed by the branch and commit number.
    ...
    if os.path.exists(sys.argv[2]):
        ...
        # If it's None, means it wasn't at that point, or an error has occured
        if old_file is None:
